...
\begin{itemize}
    \item \textit{Issue:} The iterative \texttt{run\_\allowbreak arrangement()} function initially caused nodes to vibrate or "jitter" \linebreak indefinitely. The forces were too aggressive, preventing the graph from reaching a stable equilibrium (rest state).
