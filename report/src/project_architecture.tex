...
The source code is organized into specific modules. Table \ref{tab:file_description} provides a detailed overview of all project files and their core functionalities.
